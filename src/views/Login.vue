    ...
    <div class="login_box">
      ...
      <el-form class="login_form" label-width="80px" hide-required-asterisk
        ...
        <el-form-item label="用户类型" prop="u_type">
          <el-select class="select_user_type"
                     placeholder="请选择用户类型"
                     v-model="loginForm.u_type">
        ...
        <el-form-item label="登录密码" prop="password">
          <el-input placeholder="请选择登录密码" prefix-icon="el-icon-lock"
    ...
    methods: {
      ...
      login() {
        this.$refs.loginFormRef.validate(async valid => { //简化promise操作
          ...
          this.saveUserType(res.data.user_type);
...
<style scoped>
  ...
  .select_school, .select_user_type {
    width: 100%;
  }
